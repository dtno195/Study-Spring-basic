	...
	<div class="container">
		<div class="row">
			<div class="col l6 s12">
				...
				<p class="grey-text text-lighten-4">World map, world regions,
					countries and cities.</p>
				<div id="world-map-markers"></div>
			</div>
			<div class="col l4 offset-l2 s12">
				<h5 class="white-text">Sales by Country</h5>
				<p class="grey-text text-lighten-4">A sample polar chart to show
					sales by country.</p>
...
<!-- ================================================
    Scripts <c:url value="/js/plugins.js"/>
    ================================================ -->
...
<script type="text/javascript"
	src="<c:url value="/js/plugins/perfect-scrollbar/perfect-scrollbar.min.js"/>"></script>


<!-- chartist -->
<script type="text/javascript"
	src="<c:url value="/js/plugins/chartist-js/chartist.min.js"/>"></script>

<!-- chartjs -->
<script type="text/javascript" src="<c:url value="/js/plugins/chartjs/chart.min.js"/>"></script>
<script type="text/javascript" src="<c:url value="/js/plugins/chartjs/chart-script.js"/>"></script>

<!-- sparkline -->
<script type="text/javascript"
	src="<c:url value="/js/plugins/sparkline/jquery.sparkline.min.js"/>"></script>
<script type="text/javascript"
	src="<c:url value="/js/plugins/sparkline/sparkline-script.js"/>"></script>

<!--jvectormap-->
<script type="text/javascript"
	src="<c:url value="/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"/>"></script>
<script type="text/javascript"
	src="<c:url value="/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"/>"></script>
<script type="text/javascript"
	src="<c:url value="/js/plugins/jvectormap/vectormap-script.js"/>"></script>
	...
	$(window)
			.load(
					function() {
						setTimeout(function() {
							Materialize.toast(
									'<span>Hiya! I am a toast.</span>', 1500);
						}, 3000);
						setTimeout(
								function() {
									Materialize
											.toast(
													'<span>You can swipe me too!</span>',
													3000);
								}, 5500);
						setTimeout(
								function() {
