...
<head>
    ...
    <meta name="msapplication-TileImage" content="<c:url value="/images/favicon/mstile-144x144.png"/>">
    <!-- For Windows Phone 
  ...
  <!-- <c:url value="/js/plugins/chartist-js/chartist.min.css"/>-->
    ...
    <link href="<c:url value="/js/plugins/jvectormap/jquery-jvectormap.css"/>" type="text/css" rel="stylesheet" media="screen,projection">
    <link href="<c:url value="/js/plugins/chartist-js/chartist.min.css"/>" type="text/css" rel="stylesheet" media="screen,projection">
...
<body>
    ...
    <!-- //////////////////////////////////////////////////////////////////////////// <c:url value="/images/materialize-logo.png"/> -->
        ...
        <div class="navbar-fixed">
            <nav class="cyan">
                <div class="nav-wrapper">
                    <h1 class="logo-wrapper"><a href="index.html" class="brand-logo darken-1"><img src="<c:url value="/images/materialize-logo.png"/>" alt="materialize logo"></a> <span class="logo-text">Materialize</span></h1>
                    ...
                    <li class="user-details cyan darken-2">
                        <div class="row">
                            <div class="col col s4 m4 l4">
                                <img src="<c:url value="/images/avatar.jpg"/>" alt="" class="circle responsive-img valign profile-image">
                            </div>
